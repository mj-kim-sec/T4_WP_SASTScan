                   ...
                   <br><br>
                    ...
                    <div>
                      ...
                      <p> <strong><?php echo esc_html('3. style'); ?></strong> <br>
                        ...
                        <strong style="color: red;"> <?php echo esc_html('Only 4 templates are available in the free version. For more styles or templates, please purchase the'); ?> <a href="https://www.quantumcloud.com/simple-link-directory/" target="_blank" target="_blank"><?php echo esc_html('premium version'); ?></a>. </strong> </p>
                    ...
                    <div style="padding: 15px 10px; border: 1px solid #ccc; text-align: center; margin-top: 20px;"> <?php echo esc_html('Crafted By:'); ?> <a href="http://www.quantumcloud.com" target="_blank"><?php echo esc_html('Web Design Company'); ?></a> <?php echo esc_html('- QuantumCloud'); ?> </div>
                  </div>
                  <!-- /post-body-content --> 
