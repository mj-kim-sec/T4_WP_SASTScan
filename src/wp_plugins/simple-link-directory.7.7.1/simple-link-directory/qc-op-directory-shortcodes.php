...
function show_qcopd_full_list( $atts = array() )
{
 ...
 //    }
	...
	$style = get_style_for_template($atts["style"]) ? get_style_for_template($atts["style"]) : $style;
    ...
    */
    ...
    // check style if empty. default simple.
    $template_code = get_style_for_template($atts["style"]) ? get_style_for_template($atts["style"]) : $style;
