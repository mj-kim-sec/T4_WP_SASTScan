        ...
        if( $wc_is_enabled && class_exists('WooCommerce') ) {
            $this->submenu = apply_filters('rx_admin_submenu', [
                ...
                'review_email' => [
                    ...
                    'callback'      =>  array((new ReviewxAdmin(REVIEWX_PLUGIN_NAME, "1.0.2")), 'review_email')
                ],
                'quick_setup' => [
                    'parent_slug'   => 'rx-admin',
                    ...
                    'callback'      =>  array((new ReviewxAdmin(REVIEWX_PLUGIN_NAME, "1.0.2")), 'quick_setup')
                ], 
                // 'reviewx_discount' => [
                //     'parent_slug'   => 'rx-admin',
                //     'page_title'    => __('Review for Discount', 'reviewx'),
                //     'menu_title'    => __('Review for Discount', 'reviewx'),
                //     'capability'    => 'manage_options',
                //     'menu_slug'     => 'reviewx-discount',
                //     'callback'      =>  array((new ReviewxAdmin(PLUGIN_NAME, "1.0.2")), 'reviewx_discount')
                // ],            
            ]);
        } else {
            $this->submenu = apply_filters('rx_admin_submenu', [
