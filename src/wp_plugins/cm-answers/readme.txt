...
Updated and tested 2021 Version. Enables users to post questions and answers (Q&A) in a stack overflow style. Includes voting, moderation, notifications, access control and more.

== Description ==

[Product Page](https://www.cminds.com/wordpress-plugins-library/answers/) | [Video](https://vimeo.com/108654995)  | [Demo](https://www.answersplugin.com/) | [User Guide](https://creativeminds.helpscoutdocs.com/category/987-answers-cma) | [AddOns](https://www.cminds.com/wordpress-plugins-library/?showfilter=No&tags=AnswerAddOn) | [Additional CM Plugins](https://www.cminds.com/wordpress-plugins-library) 

**Enables users to post questions and answers (Q&A) in a stack overflow style. Includes voting, moderation, notifications, access control and more. Updated and tested 2021 Version**
...
> * Categories - Ability to add categories and display them using a Shortcode. cat=catname  
...
> * Tags - Tags are fully supported. Administrators can control the appearance of tags with an available Tags widget. 
