            ...
            <div class="pricing-table" id="pricing-table"><h2 style="padding-left:10px;">Upgrade The Answers Plugin:</h2>
                <ul>
                   ...
                   <li style="text-align:left;"><span class="dashicons dashicons-yes"></span>Localization Support</li>
                    ...
                    <hr>
                 <a href="https://www.cminds.com/wordpress-plugins-library/seo-keyword-hound-wordpress/?utm_source=cmafree&utm_campaign=freeupgrade&upgrade=1" target="blank"><img src="' . plugin_dir_url( __FILE__ ). 'views/Hound2.png"  width="220"></a><br><br><br>
                <a href="https://www.cminds.com/wordpress-plugins-library/cm-wordpress-plugins-yearly-membership/?utm_source=cmafree&utm_campaign=freeupgrade&upgrade=1" target="blank"><img src="' . plugin_dir_url( __FILE__ ). 'views/banner_yearly-membership_220px.png"  width="220"></a><br>
           </ul>

               <ul>
                   <li class="heading">Pro<a href="https://www.cminds.com/cm-answer-store-page-content/?utm_source=cmafree&utm_campaign=freeupgrade&upgrade=1" style="float:right;font-size:11px;color:white;" target="_blank">More</a></li>
                    <li class="price">$39.00<br /> <span style="font-size:14px;">(For one Year / Site)<br />Additional pricing options available <a href="https://www.cminds.com/wordpress-plugins-library/answers?utm_source=cmafree&utm_campaign=freeupgrade&upgrade=1" target="_blank"> >>> </a></span> <br /></li>
                    <li class="action"><a href="https://www.cminds.com/cm-answer-store-page-content/?edd_action=add_to_cart&download_id=1119&edd_options[price_id]=0&utm_source=cmafree&utm_campaign=freeupgrade&upgrade=1" style="font-size:18px;" target="_blank">Upgrade Now</a></li>
                 ...
                 <li style="text-align:left;"><span class="dashicons dashicons-yes"></span>Make Forum your Homepage <span class="dashicons dashicons-admin-comments cminds-package-show-tooltip" style="color:green" title="Support turning the forum into your site homepage"></span></li>
                  ...
                  <li style="text-align:left;"><span class="dashicons dashicons-yes"></span>Multisite Support <span class="dashicons dashicons-admin-comments cminds-package-show-tooltip" style="color:green" title="Works in WordPress multisite environment. Please check licensing information regarding Multisite support"></span></li>
                   ...
                   <li style="text-align:left;"><span class="dashicons dashicons-yes"></span>Geo-Location Information <span class="dashicons dashicons-admin-comments cminds-package-show-tooltip" style="color:green" title="Support resolving user IP into a geo location information in the plugin reports "></span></li>
                    ...
                    <ul>
                  <li class="heading">Pro + Anonymous<a href="https://www.cminds.com/cm-answer-store-page-content/?utm_source=cmafree&utm_campaign=freeupgrade&upgrade=1" style="float:right;font-size:11px;color:white;" target="_blank">More</a></li>
                    <li class="price">$59.00<br /> <span style="font-size:14px;">(For one Year / 3 Sites)<br />Additional pricing options available <a href="https://www.cminds.com/cm-answer-store-page-content/?utm_source=cmafree&utm_campaign=freeupgrade&upgrade=1" target="_blank"> >>> </a></span> <br /></li>
                    <li class="action"><a href="https://www.cminds.com/cm-answer-store-page-content/?edd_action=add_to_cart&download_id=15723&dd_options[price_id]=0&utm_source=cmafree&utm_campaign=freeupgrade&upgrade=1" style="font-size:18px;" target="_blank">Upgrade Now</a></li>
                    ...
                    <ul>
                   <li class="heading">Ultimate<a href="https://www.cminds.com/cm-answer-store-page-content/" style="float:right;font-size:11px;color:white;" target="_blank">More</a></li>
                    <li class="price">$119.00<br /> <span style="font-size:14px;">(For one Year / 10 Sites)<br />Additional pricing options available <a href="https://www.cminds.com/cm-answer-store-page-content/?utm_source=cmafree&utm_campaign=freeupgrade&upgrade=1" target="_blank"> >>> </a></span> <br /></li>
                    <li class="action"><a href="https://www.cminds.com/cm-answer-store-page-content/?edd_action=add_to_cart&download_id=146678&&edd_options[price_id]=1&utm_source=cmafree&utm_campaign=freeupgrade&upgrade=1" style="font-size:18px;" target="_blank">Upgrade Now</a></li>
                     <li style="text-align:left;"><span class="dashicons dashicons-plus-alt"></span><span style="background-color:lightyellow">&nbsp;All Free and Pro Version Features</span> <span class="dashicons dashicons-admin-comments cminds-package-show-tooltip" style="color:green" title="All free and pro features are supported"></span></li>
