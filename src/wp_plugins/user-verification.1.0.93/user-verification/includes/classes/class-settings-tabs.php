...
?>
        ...
        public function field_wp_editor($option)
        {
            ...
            $editor_settings = isset($option['editor_settings']) ? $option['editor_settings'] : array('textarea_name' => $field_name, 'teeny' => false,  'textarea_rows' => 15, 'media_buttons' => true, 'quicktags' => true,);
        ...
        ?>
            ...
            field-wp_editor-wrapper-<?php echo esc_attr($id); ?>">
                <?php
                wp_editor(wp_specialchars_decode($value, ENT_QUOTES), $css_id, $editor_settings);
                ?>
                <div class="error-mgs"></div>
            </div>
        ...
        public function field_textarea_editor($option)
        {
            ...
            ob_start();
        ?>
            <textarea editor_enabled="no" class="textarea-editor" name="<?php echo esc_attr($field_name); ?>" id="<?php echo esc_attr($css_id); ?>" cols="40" rows="5" placeholder="<?php echo esc_attr($placeholder); ?>"><?php echo esc_attr($value); ?></textarea>
        <?php
