			...
			echo '<h2>Addons & Licenses</h2>' . sp_client_upload_nav_menu() . '';
				...
				$addons = apply_filters('spcdm/addons', array());
					...
					$p_addons = get_transient('sp_cdm_premium_feed');
                      ...
                      echo '<div class="sp_cdm_error"> '.$request->get_error_message().'<br> Connection Info: https://smartypantsplugins.com/addons.php?premium=1</div>';     
                     }
					}
					...
					$available_addons = get_transient('sp_cdm_premium_addon_feed');
                         ...
                         echo '<div class="sp_cdm_error"> '.$request->get_error_message().' <br>Connection Info: https://smartypantsplugins.com/addons.php</div>';  
                     }
