...
//			'cb'            => '<input type="checkbox" />',
	...
	public function extra_tablenav( $which ){
		...
		$extra_tablenav = '<div class="alignleft actions ulisting-main">
							<input style="width: 50px;" type="text" name="filter[id]" value="'.$id.'" placeholder="'.esc_html__("Search by id", "ulisting").'">
							<input style="width: 90px;" type="text" name="filter[user]" value="'.$user.'" placeholder="'.esc_html__("Search by User", "ulisting").'">
							...
							<input style="width: 140px;" type="date" name="filter[expired_date]" value="'.$expired_date .'" placeholder="'.esc_html__("Expired date", "ulisting").'" />
							<input style="width: 140px;" type="date" name="filter[created_date]" value="'.$created_date .'" placeholder="'.esc_html__("Created date", "ulisting").'" />
							<input style="width: 140px;" type="date" name="filter[updated_date]" value="'.$updated_date .'" placeholder="'.esc_html__("Updated date", "ulisting").'" />
							<button class="button">'.esc_html__('Apply', "ulisting").'</button>
						  </div>';

		echo apply_filters('stm_no_echo_variable', $extra_tablenav);
	}
