...
//        $result[''] = __('Select Page', 'ulisting');
    ...
    public static function plugin_text_domain($title) {
        return esc_html__($title, 'ulisting');
    }
    ...
    public static function stm_plugin_settings() {
        $result = [
            'status'  => 'error',
            'success' => true,
            'message' => self::plugin_text_domain('Permission denied')
        ];
    ...
    public static function stm_settings_save() {
        ...
        if ( current_user_can('manage_options') && (isset($_POST['action']) && sanitize_text_field($_POST['action']) === 'stm_settings_save') ) {
    ...
    public static function stm_save_template() {
        ...
        if ( current_user_can('manage_options') && (isset($_POST['action']) && sanitize_text_field($_POST['action']) === 'stm_save_template') ) {
    ...
    public static function stm_generate_pages() {
        ...
        if ( current_user_can( 'manage_options' ) && isset($_POST['pages']) && isset($_POST['action']) && sanitize_text_field($_POST['action']) === 'stm_generate_pages' ) {
    ...
    public static function toggle_uListing_agencies()
    {
        ...
        if ( isset($_POST['mode']) && $mode = sanitize_text_field($_POST['mode']) ) {
            if ( $mode == 'install' ) {
