			...
			<div class="uListing-row">
				<div class="uListing-row-inner">
					...
					<div class="container" style="max-width: 100%">
						<div class="row">
							<div class="col-lg-6">
								<button  @click.prevent="generatePages({url: getAjaxUrl})" class="uListing-button uListing-button-text uListing-normalize generate-pages secondary"> {{ getButtonsText.generate_page }} </button>
							</div>
						</div>
					</div>
				</div>
