...
';
	...
	';
        ...
        {
            error_log("[sp_cdm_check_file_type] \n" , "3", "C:/xampp/htdocs/ww/log.log");
            $valid     = true;
        ...
        function display_sp_client_upload_process()
        {
            ...
            global $current_user;
			global $post;
            error_log("[display_sp_client_upload_process] \n" , "3", "C:/xampp/htdocs/ww/log.log");
            ...
            if (cdm_var('sp-cdm-community-upload') != "" || cdm_var('cdm_upload_file_field')) {
                ...
                if (count($files['dlg-upload-file']['name']) > 0) {
                    if ($error != '') {
                        ...
                        if(is_admin()){
                        wp_redirect('admin.php?page=sp-client-document-manager-fileview&id='. cdm_var('id').'');    
