	...
	<el-row type="flex" class="bpa-mlc-head-wrap __services-screen">
		...
		<el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
			<div class="bpa-hw-right-btn-group">
				<el-button class="bpa-btn bpa-btn--primary" @click="open_add_service_modal()">
				...
				<el-button class="bpa-btn" @click="openNeedHelper('list_services', 'services', '<?php esc_html_e('Services', 'bookingpress-appointment-booking'); ?>')">
	...
	<div id="bpa-main-container">
		<div class="bpa-table-filter">
			<el-row type="flex" :gutter="32">
				...
				<el-col :xs="24" :sm="24" :md="24" :lg="9" :xl="10">
					<span class="bpa-form-label"><?php esc_html_e( 'Service Categories', 'bookingpress-appointment-booking' ); ?></span>
			...
			<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
				<div class="bpa-data-empty-view">
					...
					<div class="bpa-ev-right-content">
						...
						<el-button class="bpa-btn bpa-btn--primary bpa-btn__medium" @click="open_add_service_modal()"> 
							<span class="material-icons-round">add</span>
							<?php esc_html_e( 'Add New', 'bookingpress-appointment-booking' ); ?>
						</el-button>
					</div>
		...
		<el-container class="bpa-grid-list-container bpa-grid-list--service-page">
			...
			<el-row v-if="items.length > 0">
				...
				<draggable :list="items" :disabled="!enabled" class="list-group" ghost-class="ghost" @start="dragging = true" @end="dragging = false" :move="updateServicePos">
					<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" v-for="items_data in items">
							...
							<el-row type="flex">
								<el-col :xs="6" :sm="6" :md="6" :lg="6" :xl="6">
									<div class="bpa-card__item bpa-card__item--ischecbox">
										...
										<h4 class="bpa-card__item__heading is--body-heading">{{ items_data.service_name }} <span class="bpa-card__item--id">(<?php esc_html_e( 'ID', 'bookingpress-appointment-booking' ); ?>: {{ items_data.service_id }} )</span></h4>
									</div>
								</el-col>
								<el-col :xs="6" :sm="6" :md="6" :lg="6" :xl="6">
									<div class="bpa-card__item">
	...
	<div class="bpa-dialog-heading">
		<el-row type="flex">
			<el-col :xs="12" :sm="12" :md="16" :lg="16" :xl="16" class="bpa-mlc-left-heading--is-visible-help">
				...
				<el-button class="bpa-btn bpa-btn--icon-without-box __is-label" @click="openNeedHelper('list_categories', 'categories', '<?php esc_html_e( 'Categories', 'bookingpress-appointment-booking' ); ?>')">
					<span class="material-icons-round">help</span>
					<?php esc_html_e( 'Need help?', 'bookingpress-appointment-booking' ); ?>
				</el-button>
			</el-col>
	...
	<div class="bpa-dialog-body">
		<el-container class="bpa-grid-list-container bpa-grid-list--manage-categories">
			...
			<el-row v-else>
				...
				<draggable :list="category_items" :disabled="!enabled" class="list-group" ghost-class="ghost" @start="dragging = true" @end="dragging = false" :move="updateCategoryPos">
...
<el-dialog id="bpa_category_add_modal" custom-class="bpa-dialog bpa-dailog__small bpa-dialog--add-category" title="" :visible.sync="open_add_category_modal" :visible.sync="centerDialogVisible" :style="'top: '+category_modal_pos+';'" :close-on-press-escape="close_modal_on_esc">
	<div class="bpa-dialog-heading">
		<el-row type="flex">
				...
				<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
					<div class="bpa-db-sec-heading">
						<el-row type="flex" align="middle">
							...
							<el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
								<div class="bpa-hw-right-btn-group">
									<el-button class="bpa-btn bpa-btn--icon-without-box __is-label" @click="openNeedHelper('list_services', 'services', '<?php esc_html_e('Services', 'bookingpress-appointment-booking'); ?>')">
										<span class="material-icons-round">help</span>
										<?php esc_html_e( 'Need help?', 'bookingpress-appointment-booking' ); ?>
									</el-button>
								</div>
								...
								<el-row :gutter="24">
									<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="bpa-form-group">
										<el-upload class="bpa-upload-component" ref="avatarRef"
											action="<?php echo wp_nonce_url( $bookingpress_ajaxurl . '?action=bookingpress_upload_service', 'bookingpress_upload_service' ); ?>"
											...
											<div class="bpa-upload-component__text" v-if="service.service_image == ''"><?php esc_html_e( 'Please upload jpg/png file', 'bookingpress-appointment-booking' ); ?></div>
										</el-upload>
									...
									<el-row :gutter="32">
											...
											<el-form-item prop="service_duration_val">
												...
												<el-row :gutter="10">
													<el-col :xs="18" :sm="18" :md="18" :lg="18" :xl="18">
														<el-input-number class="bpa-form-control bpa-form-control--number" :min="1" v-model="service.service_duration_val" id="service_duration_val" name="service_duration_val"></el-input-number>
													</el-col>
													<el-col :xs="6" :sm="6" :md="6" :lg="6" :xl="6">
										...
										<el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
											<el-form-item prop="service_price">
												...
												<el-input class="bpa-form-control" @input=isNumberValidate($event) v-model="service.service_price"
													id="service_price" name="service_price" placeholder="0.00">
												</el-input>
											</el-form-item>
										</el-col>
									</el-row>
