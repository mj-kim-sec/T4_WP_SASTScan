				...
				<el-row :gutter="12">					
					...
					<el-col :xs="24" :sm="24" :md="24" :lg="16" :xl="16">
						<el-select v-model="selected_bookingpress_shortcode" class="bpa-form-control" placeholder="<?php esc_html_e( 'Select shortcode', 'bookingpress-appointment-booking' ); ?>">
							<el-option label="<?php esc_html_e( 'BookingPress step-by-step wizard form', 'bookingpress-appointment-booking' ); ?>" value="bookingpress_form"></el-option>
							<el-option label="<?php esc_html_e( 'Customer panel - My Appointments', 'bookingpress-appointment-booking' ); ?>" value="bookingpress_my_appointments"></el-option>
						</el-select>						
				</el-row>		
				<el-row :gutter="24">				
