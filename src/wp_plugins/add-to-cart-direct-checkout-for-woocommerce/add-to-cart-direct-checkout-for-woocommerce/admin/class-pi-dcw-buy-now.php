...
class Class_Pi_Dcw_Buy_Now{
    ...
    function __construct($plugin_name){
        ...
        $this->settings = array(
            ...
            array('field'=>'pisol_dcw_remove_other_product','desc'=>'When product is added by Buy now button other product from the cart will be removed and only Buy now product will remain in the cart', 'label'=>__('Remove other product from cart','pi-dcw'),'type'=>'switch', 'default'=>0,  'pro'=>true),
