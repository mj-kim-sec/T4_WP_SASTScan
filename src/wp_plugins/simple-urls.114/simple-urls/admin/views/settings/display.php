						...
						<div class="form-group">
							<div class="form-row mb-4">
								<div class="col-lg">
									...
									<input type="text" name="display_color_main" value="<?php echo $main_color; ?>" class="form-control color-picker" placeholder="#5E36CA" />
								</div>
								...
								<div class="col-lg">
									...
									<input type="text" name="display_color_title" value="<?php echo $title_color; ?>" class="form-control color-picker" placeholder="#FFFFFF" />
								</div>
							</div>
							...
							<div class="form-row mb-4">
								<div class="col-lg">
									...
									<input type="text" name="display_color_background" value="<?php echo $bg_color; ?>" class="form-control color-picker" placeholder="#FFFFFF" />
								</div>
								...
								<div class="col-lg">
									...
									<input type="text" name="display_color_button_text" value="<?php echo $button_text_color; ?>" class="form-control color-picker" placeholder="#FFFFFF" />
								</div>
							</div>
							...
							<div class="form-row mb-4">
								<div class="col-lg">
									...
									<input type="text" name="display_color_pros" value="<?php echo $pros_color; ?>" class="form-control color-picker" placeholder="#FFFFFF" />
								</div>
								...
								<div class="col-lg">
									...
									<input type="text" name="display_color_cons" value="<?php echo $cons_color; ?>" class="form-control color-picker" placeholder="#FFFFFF" />
								</div>
							</div>
					...
					<div class="col-lg-6 mb-lg-0 mb-5 h-100">
						<div class="form-row mb-4">
							<div class="col-lg">
								...
								<input type="text" name="primary_button_text" value="<?php echo $primary_button_text; ?>" class="form-control" placeholder="Buy Now" />
							</div>

							<div class="col-lg">
								<label data-tooltip="This is the color of your display's main CTA button.">&nbsp;</label>
								<input type="text" name="display_color_button" value="<?php echo $button_color; ?>" class="form-control color-picker" placeholder="#22BAA0" />
							</div>
						</div>
						...
						<div class="form-row mb-4">
							<div class="col-lg">
								...
								<input type="text" name="secondary_button_text" value="<?php echo $secondary_button_text; ?>" class="form-control" placeholder="Learn More" />
							</div>

							<div class="col-lg">
								<label data-tooltip="This is the color of your display's secondary CTA button.">&nbsp;</label>
								<input type="text" name="display_color_secondary_button" value="<?php echo $secondary_button_color; ?>" class="form-control color-picker" placeholder="#22BAA0" />
							</div>
						</div>
