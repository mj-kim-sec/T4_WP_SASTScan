							...
							<div class="form-group">
								<label class="toggle m-0 mr-1">
									<input id="general_enable_new_ui"
										...
										<?php echo $general_enable_new_ui; ?>
									>
									<span class="slider"></span>
								</label>
							...
							<div class="form-group">
								<label class="toggle m-0 mr-1">
									<input id="general_disable_amazon_notifications"
										type="checkbox"
										name="general_disable_amazon_notifications" <?php echo $general_disable_amazon_notifications; ?>>
									<span class="slider"></span>
								</label>
							...
							<div class="form-group">
								<label class="toggle m-0 mr-1">
									<input id="general_disable_tooltip"
										type="checkbox"
										name="general_disable_tooltip" <?php echo $general_disable_tooltip_checked; ?>>
									<span class="slider"></span>
								</label>
							...
							<div class="form-group mb-1">
								<label class="toggle m-0 mr-1">
									<input id="general_disable_notification"
										type="checkbox"
										name="general_disable_notification" <?php echo $general_disable_notification; ?>>
									<span class="slider"></span>
								</label>
