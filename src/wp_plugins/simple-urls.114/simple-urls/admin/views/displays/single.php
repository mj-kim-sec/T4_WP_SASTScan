...
<div id="<?php echo $anchor_id; ?>" class="lasso-container lasso-lite">
	<!-- LASSO DISPLAY BOX (https://getlasso.co) -->
	<div class="lasso-display lasso-cactus">
		<!-- BADGE -->
		<div class="lasso-badge <?php echo $badge_display_class ?>">
			<?php echo $lasso_lite_url->display->badge_text; ?>
		</div>

		<div class="lasso-box-1">
			<!-- LASSO TITLE -->
			<?php echo $title_type_start; ?>
			<a class="lasso-title" <?php echo $lasso_url_obj->render_attributes(); ?>><?php echo $title_name; ?></a>
			<?php echo $title_type_end; ?>
			<div class="clear"></div>

			<!-- LASSO PRICE -->
			<div class="lasso-price <?php echo $show_price_class ?>">
				<div class="lasso-price-value <?php echo $price_display_class ?>">
					<span class="latest-price"><?php echo $lasso_lite_url->price; ?></span>
				</div>
			</div>
			<div class="clear"></div>
			...
			<?php if ( ! empty( $lasso_lite_url->description ) ) : ?>
				<div class="lasso-lite-description"><?php echo $lasso_lite_url->description; ?></div>
			<?php endif; ?>
		</div>
		...
		<div class="lasso-box-2">
			<a class="lasso-image" <?php echo $lasso_url_obj->render_attributes(); ?>>
				<img src="<?php echo $lasso_lite_url->image_src; ?>" height="500" width="500" <?php echo Helper::build_img_lazyload_attributes() ?> alt="<?php echo $image_alt ?>" />
			</a>
		</div>

		<!-- BUTTONS -->
		<div class="lasso-box-3">
			<a class="lasso-button-1" <?php echo $lasso_url_obj->render_attributes(); ?>><?php echo $lasso_lite_url->display->primary_button_text; ?></a>
		</div>
		...
		<div class="lasso-box-5">
			<div class="lasso-disclosure <?php echo $disclosure_display_class ?>">
				<span><?php echo $lasso_lite_url->display->disclosure_text; ?></span>
			</div>
		</div>
		...
		<div class="lasso-box-6">
			<div class="lasso-date">
				...
				if ( empty( $show_price_class ) && empty( $price_display_class ) && ! empty( $lasso_lite_url->price ) ) {
					// phpcs:ignore
					echo $lasso_lite_url->display->last_updated . ' <i class="lasso-amazon-info" data-tooltip="Price and availability are accurate as of the date and time indicated and are subject to change."></i>';
				}
				?>
			</div>
		</div>
