...
if ( isset( $lasso_lite_url->category ) ) {
	...
	foreach ( $groups as $group ) {
		...
		$category_options .= '<option name="affiliate_categories" value="' . $group->get_id() . '" ' . $selected . '>' . $group->get_post_title() . '</option>';
	}
}
				...
				<div class="col-lg-5 mb-lg-0 mb-5 h-100">
					<div class="white-bg rounded shadow p-4">
						<div class="d-none">
							...
							<input id="lasso-lite-id" class="" type="hidden" value="<?php echo $lasso_lite_url->id; ?>">
							<input name="uri" class="lasso-admin-input" type="text" value="<?php echo $lasso_lite_url->id; ?>">
							<input name="guid" class="lasso-admin-input hidden" type="text" value="<?php echo $lasso_lite_url->guid; ?>">
						</div>
						...
						<div class="form-group mb-4">
							...
							<input id="affiliate_name" name="affiliate_name" type="text" class="form-control" value="<?php echo str_replace( '"', '&quot;', $lasso_lite_url->name ); ?>" placeholder="URL Name Goes Here">
						</div>
						...
						<div class="form-group mb-4 permalink-wrapper <?php echo $permalink_display_class ?>">
							...
							<input id="permalink" name="permalink" type="text" class="form-control" value="<?php echo $lasso_lite_url->slug; ?>" placeholder="affiliate-name">
						</div>
						...
						<div class="row">
							<div class="col-lg-8">
								<div class="form-group mb-4">
									...
									<input id="surl_redirect"
										...
										name="surl_redirect"
										type="text"
										data-original-value="<?php echo $lasso_lite_url->target_url ?>"
										value="<?php echo $lasso_lite_url->target_url; ?>"
							...
							<div class="col-lg-4">
								<div class="form-group mb-4">
									...
									<input type="text"
										class="form-control"
										id="buy_btn_text"
										value="<?php echo $lasso_lite_url->display->primary_button_text; ?>"
										placeholder="<?php echo $lasso_lite_url->display->primary_button_text_default; ?>">
								</div>
							</div>

							<div class="col-lg mb-4">
								<label class="toggle m-0 mr-1">
									<input id="url-open-link" name="open_new_tab" type="checkbox" <?php echo $lasso_lite_url->url_detail_checkbox->open_new_tab; ?>>
							...
							<div class="col-lg text-right">
								<label class="toggle m-0 mr-1">
									<input name="enable_nofollow" id="url-en-nofollow" type="checkbox" <?php echo $lasso_lite_url->url_detail_checkbox->enable_nofollow; ?>>
									<span class="slider"></span>
								</label>
				...
				<div class="col-lg-7">
					<div class="white-bg rounded shadow p-4">
									...
									<div class="lasso-display lasso-cactus">
										...
										<div class="lasso-box-3">
											<a class="lasso-button-1" target="_blank" href="#" rel="">
												<?php echo $lasso_lite_url->display->primary_button_text_default; ?>
											</a>
										</div>
									</div>
								</div>
						...
						<div class="image_container position-relative d-none image_editor_wrapper" id="image_editor">
							<a href="#" id="lasso-thumbnail">
								<div class="image_wrapper d-block">
									<img id="render_thumbnail" src="<?php echo $lasso_lite_url->image_src; ?>" loading="lazy" class="render_thumbnail img-fluid url_image">
									<div class="image_loading d-none"></div>
									<div class="image_hover">
										<div class="image_update"><i class="far fa-camera-alt"></i> Update Image</div>
									</div>
						...
						<input type="hidden" id="thumbnail_id" name="thumbnail_id" value="<?php echo $lasso_lite_url->thumbnail_id; ?>"/>
							...
							<div class="col-lg">
								<div class="form-group mb-4">
									...
									<input id="badge_text"
										...
										value="<?php echo $lasso_lite_url->display->badge_text; ?>">
								</div>
							</div>
							<div class="col-lg">
								<div class="form-group">
									...
									<div class="float-right">
										...
										<label class="toggle">
											<input id="show_pricing" type="checkbox" <?php echo $lasso_lite_url->url_detail_checkbox->show_price; ?>>
											<span class="slider"></span>
										</label>
									</div>
									<input name="price" type="text" id="price" class="form-control" value="<?php echo $lasso_lite_url->price; ?>" placeholder="$99.99" <?php echo $price_disabled; ?> >
									<?php if ( $amazon_product_id ): // ? Can't change the price of an Amazon Product ?>
										<em class="small"><span class="dark-gray">Amazon prices updated via </span> 
											<a target="_blank" href="<?php echo $amazon_setting_page ?>" class="purple underline">Amazon API settings</a>
										</em>
									<?php endif; ?>
								</div>
							</div>
						...
						<div class="form-group mb-3">
							<div class="form-row">
								...
								<div class="col-lg-6">
									<label class="toggle m-0 mr-1">
										<input id="show_disclosure" type="checkbox" <?php echo $lasso_lite_url->url_detail_checkbox->show_disclosure; ?>>
										<span class="slider"></span>
									</label>
						...
						<div class="form-group mb-1">
							<div class="form-row">
								<div class="col-lg">
									<label class="toggle m-0 mr-1">
										<input id="enable_sponsored" name="enable_sponsored" type="checkbox" <?php echo $lasso_lite_url->url_detail_checkbox->enable_sponsored; ?>>
										<span class="slider"></span>
									</label>
