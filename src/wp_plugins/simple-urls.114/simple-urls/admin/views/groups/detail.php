						...
						<div class="row">
							<div class="col-lg">
								...
								<div class="form-group mb-4">
									...
									<input type="text" class="form-control" id="grp_name" name="grp_name" value="<?php echo $name ?>" required placeholder="Group Name Goes Here">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-lg-6">
						...
						<div class="form-group">
							...
							<textarea type="text" class="form-control" id="grp_desc" name="grp_desc" rows="3"><?php echo $description ?></textarea>
						</div>
					</div>
				</div>
			</div>
