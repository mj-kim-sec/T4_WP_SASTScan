...
use PodlovePublisher_Vendor\Twig\NodeVisitor\SafeAnalysisNodeVisitor;
\class_exists('PodlovePublisher_Vendor\\Twig\\NodeVisitor\\SafeAnalysisNodeVisitor');
...
if (\false) {
    ...
    class Twig_NodeVisitor_SafeAnalysis extends \PodlovePublisher_Vendor\Twig\NodeVisitor\SafeAnalysisNodeVisitor
    {
    }
}
