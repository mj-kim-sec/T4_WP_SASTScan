...
\class_exists('PodlovePublisher_Vendor\\Twig\\Node\\Expression\\TestExpression');
...
if (\false) {
    ...
    class Twig_Node_Expression_Test extends \PodlovePublisher_Vendor\Twig\Node\Expression\TestExpression
    {
    }
}
