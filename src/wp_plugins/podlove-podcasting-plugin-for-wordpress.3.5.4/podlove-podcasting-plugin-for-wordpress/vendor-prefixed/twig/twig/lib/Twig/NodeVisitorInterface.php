...
\class_exists('PodlovePublisher_Vendor\\Twig\\NodeVisitor\\NodeVisitorInterface');
...
if (\false) {
    ...
    class Twig_NodeVisitorInterface extends \PodlovePublisher_Vendor\Twig\NodeVisitor\NodeVisitorInterface
    {
    }
}
