...
use PodlovePublisher_Vendor\Twig\Loader\ExistsLoaderInterface;
\class_exists('PodlovePublisher_Vendor\\Twig\\Loader\\ExistsLoaderInterface');
...
if (\false) {
    ...
    class Twig_ExistsLoaderInterface extends \PodlovePublisher_Vendor\Twig\Loader\ExistsLoaderInterface
    {
    }
}
