...
class Node implements \Countable, \IteratorAggregate
{
    ...
    public function setSourceContext(\PodlovePublisher_Vendor\Twig\Source $source)
    {
...
@\class_alias('PodlovePublisher_Vendor\\Twig\\Node\\Node', 'PodlovePublisher_Vendor\\Twig_Node');
// Ensure that the aliased name is loaded to keep BC for classes implementing the typehint with the old aliased name.
\class_exists('PodlovePublisher_Vendor\\Twig\\Compiler');
