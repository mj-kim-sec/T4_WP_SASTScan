 ...
 */
final class SpacelessTokenParser extends \PodlovePublisher_Vendor\Twig\TokenParser\AbstractTokenParser
{
    public function parse(\PodlovePublisher_Vendor\Twig\Token $token)
    {
        ...
        return new \PodlovePublisher_Vendor\Twig\Node\SpacelessNode($body, $lineno, $this->getTag());
    }
    public function decideSpacelessEnd(\PodlovePublisher_Vendor\Twig\Token $token)
    {
...
@\class_alias('PodlovePublisher_Vendor\\Twig\\TokenParser\\SpacelessTokenParser', 'PodlovePublisher_Vendor\\Twig_TokenParser_Spaceless');
