 ...
 */
class IfNode extends \PodlovePublisher_Vendor\Twig\Node\Node
{
    public function __construct(\PodlovePublisher_Vendor\Twig\Node\Node $tests, \PodlovePublisher_Vendor\Twig\Node\Node $else = null, int $lineno, string $tag = null)
    {
        $nodes = ['tests' => $tests];
        if (null !== $else) {
            $nodes['else'] = $else;
...
@\class_alias('PodlovePublisher_Vendor\\Twig\\Node\\IfNode', 'PodlovePublisher_Vendor\\Twig_Node_If');
