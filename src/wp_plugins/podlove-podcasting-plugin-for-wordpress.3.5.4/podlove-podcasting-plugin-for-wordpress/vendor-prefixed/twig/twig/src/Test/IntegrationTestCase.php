 ...
 */
abstract class IntegrationTestCase extends \PodlovePublisher_Vendor\PHPUnit\Framework\TestCase
{
    /**
     * @return string
     */
    ...
    protected function doIntegrationTest($file, $message, $condition, $templates, $exception, $outputs, $deprecation = '')
    {
        ...
        $loader = new \PodlovePublisher_Vendor\Twig\Loader\ArrayLoader($templates);
        foreach ($outputs as $i => $match) {
            $config = \array_merge(['cache' => \false, 'strict_variables' => \true], $match[2] ? eval($match[2] . ';') : []);
            $twig = new \PodlovePublisher_Vendor\Twig\Environment($loader, $config);
            ...
            try {
                ...
                throw new \PodlovePublisher_Vendor\Twig\Error\Error(\sprintf('%s: %s', \get_class($e), $e->getMessage()), -1, null, $e);
            } finally {
            ...
            try {
                ...
                $e = new \PodlovePublisher_Vendor\Twig\Error\Error(\sprintf('%s: %s', \get_class($e), $e->getMessage()), -1, null, $e);
...
@\class_alias('PodlovePublisher_Vendor\\Twig\\Test\\IntegrationTestCase', 'PodlovePublisher_Vendor\\Twig_Test_IntegrationTestCase');
