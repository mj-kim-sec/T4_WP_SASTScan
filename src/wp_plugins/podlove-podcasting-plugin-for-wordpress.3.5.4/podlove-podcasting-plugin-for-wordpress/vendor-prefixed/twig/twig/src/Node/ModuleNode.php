 ...
 */
class ModuleNode extends \PodlovePublisher_Vendor\Twig\Node\Node
{
    public function __construct(\PodlovePublisher_Vendor\Twig\Node\Node $body, \PodlovePublisher_Vendor\Twig\Node\Expression\AbstractExpression $parent = null, \PodlovePublisher_Vendor\Twig\Node\Node $blocks, \PodlovePublisher_Vendor\Twig\Node\Node $macros, \PodlovePublisher_Vendor\Twig\Node\Node $traits, $embeddedTemplates, \PodlovePublisher_Vendor\Twig\Source $source)
    {
        ...
        $nodes = ['body' => $body, 'blocks' => $blocks, 'macros' => $macros, 'traits' => $traits, 'display_start' => new \PodlovePublisher_Vendor\Twig\Node\Node(), 'display_end' => new \PodlovePublisher_Vendor\Twig\Node\Node(), 'constructor_start' => new \PodlovePublisher_Vendor\Twig\Node\Node(), 'constructor_end' => new \PodlovePublisher_Vendor\Twig\Node\Node(), 'class_end' => new \PodlovePublisher_Vendor\Twig\Node\Node()];
        if (null !== $parent) {
            $nodes['parent'] = $parent;
        }
    ...
    protected function compileTemplate(\PodlovePublisher_Vendor\Twig\Compiler $compiler)
    {
    ...
    protected function compileGetParent(\PodlovePublisher_Vendor\Twig\Compiler $compiler)
    {
    ...
    protected function compileClassHeader(\PodlovePublisher_Vendor\Twig\Compiler $compiler)
    {
        $compiler->write("\n\n");
        if (!$this->getAttribute('index')) {
    ...
    protected function compileConstructor(\PodlovePublisher_Vendor\Twig\Compiler $compiler)
    {
    ...
    protected function compileDisplay(\PodlovePublisher_Vendor\Twig\Compiler $compiler)
    {
    ...
    protected function compileClassFooter(\PodlovePublisher_Vendor\Twig\Compiler $compiler)
    {
        $compiler->subcompile($this->getNode('class_end'))->outdent()->write("}\n");
    }
    protected function compileMacros(\PodlovePublisher_Vendor\Twig\Compiler $compiler)
    {
        $compiler->subcompile($this->getNode('macros'));
    }
    protected function compileGetTemplateName(\PodlovePublisher_Vendor\Twig\Compiler $compiler)
    {
        $compiler->write("public function getTemplateName()\n", "{\n")->indent()->write('return ')->repr($this->getSourceContext()->getName())->raw(";\n")->outdent()->write("}\n\n");
    }
    protected function compileIsTraitable(\PodlovePublisher_Vendor\Twig\Compiler $compiler)
    {
        ...
        if ($traitable) {
            if ($this->getNode('body') instanceof \PodlovePublisher_Vendor\Twig\Node\BodyNode) {
                $nodes = $this->getNode('body')->getNode(0);
            } else {
                $nodes = $this->getNode('body');
            }
            if (!\count($nodes)) {
                $nodes = new \PodlovePublisher_Vendor\Twig\Node\Node([$nodes]);
            }
            foreach ($nodes as $node) {
                ...
                if ($node instanceof \PodlovePublisher_Vendor\Twig\Node\BlockReferenceNode) {
                    continue;
                }
                $traitable = \false;
                break;
    ...
    protected function compileDebugInfo(\PodlovePublisher_Vendor\Twig\Compiler $compiler)
    {
        $compiler->write("public function getDebugInfo()\n", "{\n")->indent()->write(\sprintf("return %s;\n", \str_replace("\n", '', \var_export(\array_reverse($compiler->getDebugInfo(), \true), \true))))->outdent()->write("}\n\n");
    }
    protected function compileGetSourceContext(\PodlovePublisher_Vendor\Twig\Compiler $compiler)
    {
    ...
    protected function compileLoadTemplate(\PodlovePublisher_Vendor\Twig\Compiler $compiler, $node, $var)
    {
        if ($node instanceof \PodlovePublisher_Vendor\Twig\Node\Expression\ConstantExpression) {
...
@\class_alias('PodlovePublisher_Vendor\\Twig\\Node\\ModuleNode', 'PodlovePublisher_Vendor\\Twig_Node_Module');
