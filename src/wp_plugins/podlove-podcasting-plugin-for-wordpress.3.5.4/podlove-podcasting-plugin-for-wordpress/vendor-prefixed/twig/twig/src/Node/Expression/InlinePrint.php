 ...
 * @internal
 */
final class InlinePrint extends \PodlovePublisher_Vendor\Twig\Node\Expression\AbstractExpression
{
    public function __construct(\PodlovePublisher_Vendor\Twig\Node\Node $node, $lineno)
    {
