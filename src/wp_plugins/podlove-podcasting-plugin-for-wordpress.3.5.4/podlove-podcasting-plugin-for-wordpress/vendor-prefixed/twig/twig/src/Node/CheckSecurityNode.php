 ...
 */
class CheckSecurityNode extends \PodlovePublisher_Vendor\Twig\Node\Node
{
    private $usedFilters;
    private $usedTags;
    ...
    public function compile(\PodlovePublisher_Vendor\Twig\Compiler $compiler)
    {
        ...
        foreach (['tags', 'filters', 'functions'] as $type) {
            foreach ($this->{'used' . \ucfirst($type)} as $name => $node) {
                if ($node instanceof \PodlovePublisher_Vendor\Twig\Node\Node) {
...
@\class_alias('PodlovePublisher_Vendor\\Twig\\Node\\CheckSecurityNode', 'PodlovePublisher_Vendor\\Twig_Node_CheckSecurity');
