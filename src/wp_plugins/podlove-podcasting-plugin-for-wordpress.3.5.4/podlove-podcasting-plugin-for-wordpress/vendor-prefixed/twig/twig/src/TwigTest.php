...
class TwigTest
{
    ...
    public function __construct(string $name, $callable = null, array $options = [])
    {
        ...
        $this->options = \array_merge(['is_variadic' => \false, 'node_class' => \PodlovePublisher_Vendor\Twig\Node\Expression\TestExpression::class, 'deprecated' => \false, 'alternative' => null], $options);
    }
...
@\class_alias('PodlovePublisher_Vendor\\Twig\\TwigTest', 'PodlovePublisher_Vendor\\Twig_SimpleTest', \false);
@\class_alias('PodlovePublisher_Vendor\\Twig\\TwigTest', 'PodlovePublisher_Vendor\\Twig_Test');
