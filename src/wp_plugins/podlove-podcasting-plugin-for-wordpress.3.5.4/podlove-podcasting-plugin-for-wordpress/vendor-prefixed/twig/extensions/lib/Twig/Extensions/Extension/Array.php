 ...
 */
class Twig_Extensions_Extension_Array extends \PodlovePublisher_Vendor\Twig_Extension
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $filters = array(new \PodlovePublisher_Vendor\Twig_SimpleFilter('shuffle', 'twig_shuffle_filter'));
        return $filters;
    }
    /**
     * {@inheritdoc}
