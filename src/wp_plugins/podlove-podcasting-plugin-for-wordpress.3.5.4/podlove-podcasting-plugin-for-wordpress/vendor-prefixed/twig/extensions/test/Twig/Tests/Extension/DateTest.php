 ...
 */
class Twig_Tests_Extension_DateTest extends \PodlovePublisher_Vendor\PHPUnit\Framework\TestCase
{
    /**
     * @var TwigEnvironment
     */
    ...
    {
        $this->env = new \PodlovePublisher_Vendor\Twig_Environment($this->getMockBuilder('Twig_LoaderInterface')->getMock());
    }
    /**
    ...
    {
        $extension = new \PodlovePublisher_Vendor\Twig_Extensions_Extension_Date();
    ...
    {
        $translator = $this->getMockBuilder('PodlovePublisher_Vendor\\Symfony\\Component\\Translation\\TranslatorInterface')->getMock();
        $translator->expects($this->once())->method('transChoice')->with($translated);
        $extension = new \PodlovePublisher_Vendor\Twig_Extensions_Extension_Date($translator);
 ...
 * @author Robin van der Vleuten <robinvdvleuten@gmail.com>
 */
@\class_alias('PodlovePublisher_Vendor\\Twig_Tests_Extension_DateTest', 'Twig_Tests_Extension_DateTest', \false);
